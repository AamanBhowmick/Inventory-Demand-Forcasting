...
def report():
    ...
    for category in categories:
        ...
        predicted_quantity_future = future_results_df['Predicted'].sum().round(
            0)
    ...
    return render_template("report.html", tables1=[df.head(10).to_html(classes='data', table_id='my-table1')], tables2=[category_predictions_df_xgb.to_html(classes='data')], tables3=[category_future_predictions_df_xgb.to_html(classes='data')])
